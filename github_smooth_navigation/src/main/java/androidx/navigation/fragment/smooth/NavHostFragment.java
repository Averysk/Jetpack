...
package androidx.navigation.fragment.smooth;
 ...
 *            android:name="androidx.navigation.fragment.smooth.NavHostFragment"
...
public class NavHostFragment extends Fragment implements NavHost {
    ...
    public void onInflate(@NonNull Context context, @NonNull AttributeSet attrs,
        ...
        final TypedArray navHost = context.obtainStyledAttributes(attrs, R.styleable.NavHost_Res);
        @SuppressLint("PrivateResource")
        final int graphId = navHost.getResourceId(R.styleable.NavHost_Res_navGraph, 0);
        if (graphId != 0) {
            mGraphId = graphId;
        }
        navHost.recycle();
