...
open class WheelView @JvmOverloads constructor(
     ...
     * 选中区域圆角弧度
     */
    private var selectedRectRound: Float = 0f
    ...
    private fun initAttrsAndDefault(context: Context, attrs: AttributeSet?) {
        ...
        selectedRectRound =
            ta.getDimension(R.styleable.WheelView_wv_selectedRectRound, 0f)
    ...
    private fun initValue(context: Context) {
        ...
        setSoundEffectResource(R.raw.button_choose)
    }
     ...
     * 获取选中区域圆角弧度
     */
    fun getSelectedRectRound(): Float {
        return selectedRectRound
    }

    /**
     * 设置选中区域圆角弧度
     */
    fun setSelectedRectRound(selectedRectRound: Float) {
        this.selectedRectRound= selectedRectRound
        invalidate()
    }
